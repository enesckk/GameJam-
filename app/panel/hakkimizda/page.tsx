...
export default function AboutPage() {
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/20 via-pink-500/15 to-blue-500/20 backdrop-blur-xl border border-purple-500/30 p-4 sm:p-6 lg:p-8">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-1">Şehitkamil Game Jam</h2>
              <p className="text-sm sm:text-base text-purple-200/80">Oyun Geliştirme Maratonu</p>
            </div>
          </div>
          
          <p className="text-sm sm:text-base leading-relaxed text-purple-100 max-w-3xl">
      ...
      <section className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={i.k} className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-4 sm:p-6 hover:scale-105 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="relative z-10">
              <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${i.color} rounded-2xl flex items-center justify-center mb-3 sm:mb-4 shadow-lg`}>
                <i.icon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
              </div>
              <div className="text-xs sm:text-sm text-purple-200/80 mb-2">{i.k}</div>
              <div className="text-base sm:text-lg font-bold text-white">{i.v}</div>
            </div>
          </div>
        ))}
      </section>
      ...
      <SectionCard title="Amaç & Değerler" subtitle="Topluluk kültürü">
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
          {[
            ...
            <div key={index} className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-4 sm:p-5 hover:scale-105 transition-all duration-300">
              <div className="flex items-start gap-3">
                <div className={`w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center flex-shrink-0`}>
                  <item.icon className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                </div>
                <p className="text-xs sm:text-sm text-purple-100 font-medium">{item.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <SectionCard title="Değerlendirme Ölçütleri" subtitle="Jüri tarafından dikkate alınan başlıklar">
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
          {[
            ...
            <div key={b.h} className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-4 sm:p-5 hover:scale-105 transition-all duration-300">
              <div className="flex items-start gap-3">
                <div className={`w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br ${b.color} rounded-xl flex items-center justify-center flex-shrink-0`}>
                  <b.icon className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                </div>
                <div>
                  <div className="text-xs sm:text-sm font-bold text-white mb-2">{b.h}</div>
                  <div className="text-xs sm:text-sm text-purple-100">{b.p}</div>
                </div>
              </div>
            </div>
          ))}
      ...
      <SectionCard title="Akış Özeti" subtitle="Yüksek seviyede plan">
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
          {[
            ...
            <div key={i} className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-4 sm:p-5 hover:scale-105 transition-all duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs sm:text-sm font-bold text-white mb-2">{s.t}</div>
                  <div className="text-xs sm:text-sm text-purple-100">{s.d}</div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-4 sm:p-6">
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm">
            <Link href="/panel/kurallar" className="inline-flex items-center gap-2 text-purple-300 hover:text-purple-200 underline underline-offset-4 font-medium">
              Kurallar sayfasına git <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4" />
            </Link>
          </div>
        </div>
      </SectionCard>
      ...
      {/* CTA */}
      <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/20 via-pink-500/15 to-blue-500/20 backdrop-blur-xl border border-purple-500/30 p-4 sm:p-6">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
          ...
          <Link
            href="/panel/mesajlar"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-white bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 hover:scale-105 transition-all duration-200 font-medium shadow-lg"
          >
            Mesaj Gönder <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4" />
          </Link>
        </div>
      </div>
    </div>
