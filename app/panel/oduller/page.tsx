    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-yellow-500/20 via-orange-500/15 to-red-500/20 backdrop-blur-xl border border-yellow-500/30 p-8">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">Ödüller & Fırsatlar</h2>
              <p className="text-yellow-200/80">Başarılarınızın karşılığı</p>
            </div>
          </div>
          
          <p className="text-base leading-relaxed text-yellow-100 max-w-2xl">
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Büyük Ödüller</h2>
      ...
      <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/20 via-indigo-500/15 to-purple-500/20 backdrop-blur-xl border border-blue-500/30 p-6 hover:scale-[1.02] transition-all duration-300">
      ...
      {/* Her katılımcıya */}
      <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-500/20 via-emerald-500/15 to-teal-500/20 backdrop-blur-xl border border-green-500/30 p-6 hover:scale-[1.02] transition-all duration-300">
      ...
      {/* Ekstra fırsatlar */}
      <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/20 via-pink-500/15 to-red-500/20 backdrop-blur-xl border border-purple-500/30 p-6 hover:scale-[1.02] transition-all duration-300">
      ...
      {/* Sponsor katkıları */}
      <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-500/20 via-blue-500/15 to-cyan-500/20 backdrop-blur-xl border border-indigo-500/30 p-6 hover:scale-[1.02] transition-all duration-300">
...
function AwardCard({ 
  ...
  return (
    <div className={`group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 backdrop-blur-xl border border-purple-500/20 p-6 hover:scale-105 transition-all duration-300 ${highlight ? 'shadow-xl' : ''}`}>
      ...
      <div className="relative z-10">
        <div className="flex flex-col items-center text-center gap-4">
          ...
          {/* Icon */}
          <div className={`w-16 h-16 bg-gradient-to-br ${color} rounded-3xl flex items-center justify-center shadow-lg`}>
          ...
          {/* Content */}
          <div>
            <div className="text-lg font-bold text-white mb-2">{place}</div>
            <div className="text-sm text-purple-200/80 leading-relaxed">{prize}</div>
          </div>
        </div>
      </div>
    </div>
