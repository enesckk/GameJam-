...
export default function PanelTopbar({
  ...
  return (
    <div className="sticky top-0 z-40">
      <div className="relative h-20 md:h-28 hero-gradient text-white">
  ...
  <div
    className={[
      "flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-2xl",
      "px-2.5 sm:pl-3 sm:pr-2 py-1 sm:py-1.5",
      "bg-white/10 ring-1 ring-white/20 backdrop-blur-[2px]",
      "hover:ring-white/40 transition-shadow",
      "hover:shadow-[0_0_12px_rgba(236,72,153,.25),0_0_16px_rgba(6,182,212,.25)]",
      "text-xs sm:text-sm"
    ].join(" ")}
    role="status"
    aria-live="polite"
  >
    ...
    {!isDone ? (
      <>
        <span className="hidden sm:inline mr-1 font-semibold text-white/95">
          Kalan
        </span>
      ...
      <span className="font-semibold">{countdownDoneText}</span>
            ...
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-full bg-white/15">
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 rounded-lg px-3 py-1.5 text-sm sm:text-base bg-white/10 hover:bg-white/15"
            >
