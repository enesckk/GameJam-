...
export default function AdminSidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <nav className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto no-scrollbar bg-slate-900 border-r border-slate-700">
      {/* Header */}
            ...
            >
              ...
              <div className={[
                ...
                active 
                  ...
                  : "bg-slate-700 text-slate-400 group-hover:bg-indigo-900/30 group-hover:text-indigo-400"
              ].join(" ")}>
