...
export default function AdminSidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <nav className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto no-scrollbar bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-r border-slate-200/60 dark:border-slate-700/60">
      {/* Header */}
