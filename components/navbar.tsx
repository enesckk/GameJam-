    ...
    <header
      className={[
        ...
        !isScrolled
          ...
          : "bg-gradient-to-r from-blue-900/90 via-purple-900/90 to-pink-900/90 backdrop-blur-md border-b border-blue-500/30 shadow-[0_8px_32px_rgba(59,130,246,0.15)]",
      ].join(" ")}
    >
            ...
            .map((i) => {
              ...
              return (
                <Link
                  ...
                  className="text-sm px-3 py-2 rounded-lg font-medium transition-all duration-300 hover:bg-blue-500/20 hover:text-blue-300 text-slate-300 hover:scale-105"
                >
                  {i.label}
                </Link>
              );
            ...
            <>
              ...
              <Link
                ...
                className="
                  ...
                  transition-all duration-300 hover:scale-105
                  hover:shadow-[0_8px_25px_rgba(147,51,234,0.4)]
